    ...
    <div style={{minHeight:"100vh",background:B.white,fontFamily:"'Outfit',sans-serif"}}>
      ...
      <section style={{background:B.dark,padding:"56px 24px",marginTop:30}}>
        <div style={{maxWidth:1000,margin:"0 auto"}}>
          ...
          <p style={{fontSize:15,color:"#8899aa",textAlign:"center",marginBottom:40}}>{T.howSub||"Three simple steps to your dream home."}</p>
      ...
      <section style={{textAlign:"center",padding:"56px 24px"}}>
        ...
        <p style={{fontSize:14,color:B.gray,marginBottom:16,marginTop:16}}>{lang==="pt"?"Ou veja ":"Or see "}<span onClick={onPricing} style={{color:B.blue,cursor:"pointer",fontWeight:600}}>{T.ctaPricing}</span>{lang==="pt"?" para agências.":" for agencies."}</p>
